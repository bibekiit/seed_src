...
%BLKPROC will be removed in a future release. Use BLOCKPROC instead. 
...
%   $Revision: 5.26.4.7 $  $Date: 2009/05/14 16:58:05 $
...
% deprecation warning (do not issue on sol64)
if ~strcmpi(computer,'SOL64')
    warning('Images:BLKPROC:DeprecatedFunction', ...
        'BLKPROC will be removed in a future release. Use BLOCKPROC instead.');
end
